...
<body class="antialiased">
    <nav class="flex bg-slate-700 text-white">
        ...
        <a href="/todo-list"
            class="py-4 px-6 hover:bg-slate-800 {{ request()->routeIs('todo-list') ? 'bg-slate-800' : '' }}">TodoLis</a>
        ...
        <a href="/login"
            class="py-4 px-6 hover:bg-slate-800 {{ request()->routeIs('login') ? 'bg-slate-800' : '' }}">Login</a>
    </nav>
